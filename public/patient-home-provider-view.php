...
$sql2 = "SELECT visits.created_at, users2.first_name, users2.last_name FROM visits JOIN patients ON patients.id = visits.patient_id JOIN users ON users.id = patients.user_id JOIN providers ON providers.id = visits.provider_id JOIN users AS users2 ON users2.id = providers.user_id WHERE patients.id = ?";
...
<body>
    <div class="page-header">
        <h1>Hi, <b><?php echo htmlspecialchars($_SESSION["username"]); ?></b>. Welcome to your patient portal for <?php echo htmlspecialchars($_SESSION["pusername"]);?>.</h1>
    </div>
    <div class="wrapper">
    <div>
        <?php
        echo "<table class='table'>";
        echo "<h3 class='table-header'>Visits</h2>";
            echo "<tr>";
            echo "<th> Created At</th>";
            echo "<th> Provider First Name</th>";
            echo "<th> Provider Last Name</th>";
            echo "</tr>";
    ...
    <div>
        <?php
        echo "<table class='table'>";
        echo "<h3 class='table-header'>Lab Tests</h3>";
            echo "<tr>";
            echo "<th> Created At</th>";
            echo "<th> Test</th>";
            echo "<th> Result</th>";
